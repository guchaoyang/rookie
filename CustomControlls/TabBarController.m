...
//    InviteViewController *mavc = [[InviteViewController alloc] init];
//
//    NavigationController *nav_2 = [[NavigationController alloc] initWithRootViewController:mavc];
//    nav_2.tabBarItem.image = [UIImage imageNamed:@"img_tabbar_home"];
//    nav_2.tabBarItem.selectedImage = [UIImage imageNamed:@""];
//    nav_2.tabBarItem.title = @"客服";
    /*---*/
